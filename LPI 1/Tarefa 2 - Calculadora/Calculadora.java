...
public class Calculadora {
    ...
    public Calculadora somar(Calculadora outra) {
        ...
        return new Calculadora(novoNumerador, novoDenominador);
    }
    ...
    public static void main(String[] args) {
        ...
        Calculadora[] fracoes = new Calculadora[quantidade];
        ...
        for (int i = 0; i < quantidade; i++) {
            ...
            fracoes[i] = new Calculadora(num, den);
        }
        ...
        do {
            ...
            Calculadora resultado = fracoes[0];
